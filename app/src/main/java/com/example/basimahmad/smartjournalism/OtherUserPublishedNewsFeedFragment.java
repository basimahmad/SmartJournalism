...
public class OtherUserPublishedNewsFeedFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public OtherUserPublishedNewsFeedFragment() {
    ...
    private void parseJsonFeed(JSONObject response) {
        try {
            ...
            for (int i = (feedArray.length() - 1); i >= 0; i--) {
                ...
                if(restoredID.equals(feedObj.getString("userid"))) {
