...
import com.example.basimahmad.smartjournalism.InboxFragment;
import com.example.basimahmad.smartjournalism.R;
import com.example.basimahmad.smartjournalism.helper.CircleTransform;
import com.example.basimahmad.smartjournalism.helper.FlipAnimator;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MyViewHolder> {
    ...
    private void applyImportant(MyViewHolder holder, Message message) {
        if (message.isImportant()) {
            holder.iconImp.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.star_fill));
            holder.iconImp.setColorFilter(ContextCompat.getColor(mContext, R.color.icon_tint_selected));
        } else {
            holder.iconImp.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.star));
